...
export class InitializeTables1606084186034 implements MigrationInterface {
    name = 'InitializeTables1606084186034'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "secrets" ("id" SERIAL NOT NULL, "message" character varying(280) NOT NULL, "image_url" character varying, "status" text NOT NULL, "last_review_request" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d4ff48ddba1883d4dc142b9c697" PRIMARY KEY ("id"))`);
